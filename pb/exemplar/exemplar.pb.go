...
type SampleResponse struct {
	...
	// Maps
	AMap     map[int32]bool                            `protobuf:"bytes,18,rep,name=a_map,json=aMap,proto3" json:"a_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
